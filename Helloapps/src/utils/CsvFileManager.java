...
public class CsvFileManager implements FileManager{
    ...
    private <T extends CsvConvertible> void exportToCsv(Collection<T> collection, String fileName) {
        ...
        try (FileWriter fileWriter = new FileWriter(fileName);
            ...
            throw new DataExportException("B³¹d zapisu danych do pliku " + fileName);
    ...
    private void importPublications(Library library) {
        ...
        try(BufferedReader bufferedReader = new BufferedReader(new FileReader(PUBLICATIONS_FILE_NAME))) {
            ...
            throw new DataImportException("B³¹d odczytu pliku " + PUBLICATIONS_FILE_NAME);
    ...
    private void importUsers(Library library) {
        ...
        try (BufferedReader bufferedReader = new BufferedReader(new FileReader(USERS_FILE_NAME))) {
            ...
            throw new DataImportException("B³¹d odczytu pliku " + USERS_FILE_NAME);

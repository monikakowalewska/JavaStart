...
public class LoremIpsum2 {
	public static void main(String[] args) throws IOException {
        ...
        List<String> words = reader.lines()//Metoda lines() zwraca listê wierszy tekstu
                .map(line -> line.split(" "))
                .flatMap(Arrays::stream)//flatMap(Arrays::stream) przekszta³ca wiêc Stream<String[]> na Stream<String>

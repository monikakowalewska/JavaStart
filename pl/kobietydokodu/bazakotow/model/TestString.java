...
public class TestString {
    ...
    int tab1[] = {1,2,3,4,5};
    BufferedReader odczyt1 = new BufferedReader(new InputStreamReader(System.in));
    int index1 = -1;
    ...
    while(!czyPoprawne) {
        try {
        index1 = Integer.parseInt(odczyt1.readLine());
        ...
        czyPoprawne = index1 == -1? false : true;
    }

    try {
        System.out.println(tab1[index1-1]);
    } catch (ArrayIndexOutOfBoundsException e) {
        System.out.println("Niepoprawny parametr, rozmiar tablicy to: "+tab1.length);
    }
